...
public class CUtils {
    ...
    public static final String AUTH_TOKEN = "ENTERYOURCREDENTIALSHERE";
    public static final String SMS_PHONE_NUMBER = "ENTERYOURCREDENTIALSHERE";
    ...
    public Boolean validateInput(String input, String inputType) {
        ...
        if (Objects.equals(inputType, "password")) {
            maxStringLength = 128;
            minStringLength = 8;
        } else {
            maxStringLength = 64;
        ...
        if (!Objects.equals(inputType, "Application Name")) {
            if (input.contains(" ")) {
                return false;
            }
        }
