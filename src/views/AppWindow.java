...
// class for the app window that uses the card layout to switch between JPanels as the user interacts with the gui
public class AppWindow extends JFrame {
	...
	// builds the window where the panel currently being shown by the card layout
	// screen manager will be displayed
	...
	// Initializes the screen manager which switches between views as the user
